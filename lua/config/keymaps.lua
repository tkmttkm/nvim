...
-- map("n",                    "<leader>Se",   function() Snacks.picker.explorer() end,                          { desc = "Explorer" })
-- map("n",                    "<leader>SE",   function() Snacks.picker.explorer({ cwd = vim.fn.getcwd() }) end, { desc = "Explorer(cwd)" })
...
map("n", "<leader>tE", "<cmd>Translate EN -output=<CR>",         {desc = "JP → EN コピー"})
map("n", "<leader>tj", "<cmd>Translate JA<CR>",                  {desc = "EN → JA 翻訳"})
map("n", "<leader>tJ", "<cmd>Translate JA -output=register<CR>", {desc = "EN → JA コピー"})
